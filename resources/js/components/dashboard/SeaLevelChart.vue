    ...
    <div class="flex h-full flex-col rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
        <div class="mb-4">
            ...
            <div class="mt-2 text-sm text-gray-500">
                <span class="mr-2 font-bold text-indigo-900">December 2025</span>
                <span>Wednesday, 10</span>
            </div>
        </div>
        <div class="min-h-75 relative grow">
            <Line :data="chartData" :options="chartOptions" />
        </div>
        <div class="mt-4 text-right text-xs text-gray-400">
            Source:
            <a href="https://telemetri.pushidrosal.id/enavigation/" target="_blank" class="text-green-500">Pushidrosal (Balikpapan Station)</a>
        </div>
    </div>
</template>
